...
repeat
 ...
 -- Menu/UI Creation
 if not isfile("Azure.wtf") then
    makefolder("Azure.wtf")
 end
 
 local menu = game:GetObjects("rbxassetid://15182245388")[1] 
 ...
 local function createWatermark()
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'Azure.<font color="rgb(189, 172, 255)">wtf</font> - uid: <font color="rgb(189, 172, 255)">' .. uid .. '</font> / fps: <font color="rgb(189, 172, 255)">' .. fpsValue .. '</font> / ping: <font color="rgb(189, 172, 255)">' .. ping .. '</font> / time: <font color="rgb(189, 172, 255)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = '<font color="rgb(140, 155, 253)">Velocity.vip</font>',
    keybind = Enum.KeyCode.RightBracket,
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(140, 155, 253),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(20, 20, 20),
          AccentColor = Color3.fromRGB(140, 155, 253),
            ...
            draggable(menu.bg)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenEnd = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(255,255,255)})
